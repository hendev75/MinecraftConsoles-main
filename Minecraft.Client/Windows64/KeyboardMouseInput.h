...
public:
	...
	void SetControllerType(EControllerType type) { m_controllerType = type; }
	EControllerType GetControllerType() const { return m_controllerType; }
	bool IsPlayStationController() const { return m_controllerType == CONTROLLER_TYPE_PLAYSTATION; }

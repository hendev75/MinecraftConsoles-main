...
// Returns true if any XInput controller or DS4/DualSense HID controller is connected.
#include <Xinput.h>
#include "..\..\Windows64\DS4HIDInput.h"
inline bool Win64_IsControllerConnected()
{
	// Check for DS4/DualSense via direct HID

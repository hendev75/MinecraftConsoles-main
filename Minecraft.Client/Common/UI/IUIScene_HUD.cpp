...
void IUIScene_HUD::updateFrameTick()
{
	...
	{
		bool tooltipsOn = (ui.GetMenuDisplayed(ProfileManager.GetPrimaryPad())) || (app.GetGameSettings(ProfileManager.GetPrimaryPad(),eGameSetting_Tooltips) != 0);
#ifdef _WINDOWS64
		// Hide controller tooltip area in HUD when keyboard and mouse is active
